        ...
        <ModalProvider>
            <div className="page-content">
                <Head>
                    ...
                    <meta property='og:description' content='Parce que le monde du foot mérite mieux, je m’engage à ne pas regarder les matches de la Coupe du monde de football.'/>
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <span className="horror-detail">
                                ...
                                et déplacements<sup><a href="#ref2">[2]</a></sup>. Une quantité fortement <strong>sous-estimée</strong>
                        ...
                        <li>
                            ...
                            <span className="horror-detail">
                                ...
                                officiellement aboli mais toujours en vigueur<sup><a href="#ref9">[9</a>, <a href="#ref10">10</a>, <a href="#ref11">11]</a></sup>
                            </span>
                        </li>
                    </ul>
                </div>
                ...
                <div className="actions-list">
                    ...
                    <div className="personalities-container">
                        ...
                        <ul className="personalities-list">
                            {[
                                { name: 'Régis Juanico', position: 'député de la Loire', link: 'https://www.lejdd.fr/Politique/jean-francois-debat-et-regis-juanico-boycotter-la-coupe-du-monde-au-qatar-pour-ne-pas-cautionner-4136381' },
                                { name: 'Jean-François Debat', position: 'maire de Bourg-en-Bresse', link: 'https://www.lejdd.fr/Politique/jean-francois-debat-et-regis-juanico-boycotter-la-coupe-du-monde-au-qatar-pour-ne-pas-cautionner-4136381' },
                                { name: 'Éric Cantona', position: 'ex-footballeur', link: 'https://www.eurosport.fr/football/coupe-du-monde/2022/eric-cantona-va-boycotter-la-coupe-du-monde-2022-au-qatar_sto9144232/story.shtml' },
                                { name: 'Éric Piolle', position: 'maire de Grenoble', link: 'https://www.lefigaro.fr/sports/football/coupe-du-monde/fil-info/piolle-boycottons-la-coupe-du-monde-au-qatar-1038589' },
                                { name: 'Vincent Lindon', position: 'acteur', link: 'https://www.lepoint.fr/people/un-asile-geant-vincent-lindon-pour-le-boycott-du-mondial-au-qatar-05-09-2022-2488537_2116.php' },
                                { name: 'Philippe Lahm', position: 'ex-footballeur Bayern Munich', link: 'https://www.lequipe.fr/Football/Actualites/Philipp-lahm-boycottera-la-coupe-du-monde-au-qatar-pour-des-raisons-politiques/1347197' },
                                { name: 'Alexis Corbière', position: 'député La Seine-Saint-Denis', link: 'https://www.lejdd.fr/Politique/alexis-corbiere-et-16-autres-deputes-insoumis-qatar-non-a-la-coupe-du-monde-immonde-4136203' },
                                { name: 'Jeanne Barseghian', position: 'maire de Strasbourg', link: 'https://www.sofoot.com/boycott-du-mondial-la-ville-de-strasbourg-ne-diffusera-pas-de-matchs-sur-ecrans-geants-519478.html' },
                                { name: 'Le Quotidien de la Réunion', position: '', link: 'https://www.francetvinfo.fr/coupe-du-monde/coupe-du-monde-2022-le-quotidien-de-la-reunion-boycotte-la-competition-au-qatar-et-assure-que-meme-si-la-france-est-championne-nous-ne-relaierons-pas-l-exploit-sportif_5359216.html' },
                                { name: 'Raphaël Glucksmann', position: 'député européen', link: 'https://www.linkedin.com/posts/raphaelglucksmann_signez-la-p%C3%A9tition-activity-6982591437070606336--V8e/?originalSubdomain=be' },
                                { name: 'Martine Aubry', position: 'maire de Lille', link: 'https://www.huffingtonpost.fr/politique/article/apres-strasbourg-lille-boycottera-la-coupe-du-monde-au-qatar_208430.html' },
                                { name: 'Christian Teyssèdre', position: 'maire de Rodez', link: 'https://www.nouvelobs.com/societe/20221003.OBS64027/apres-lille-et-strasbourg-bordeaux-rodez-ces-villes-qui-boycottent-la-coupe-du-monde-au-qatar.html' },
                            ].map(personality => (
                    ...
                    <div className="block-action action-second" id="profile">
                        <div className="avatar-tool">
                            ...
                            <div className="action-explain">
                                ...
                                <p>
                                    Je montre mon désaccord en téléchargeant un bandeau «&nbsp;{constants.hashtag}&nbsp;» et j’actualise ma photo de profil sur les réseaux sociaux&nbsp;:
                                </p>
                            </div>
                            <div>
                                {
                ...
                <div className="go-further">
                    <div className="further-action">
                        ...
                        <ul>
                            <li>
                                Boycotter les sponsors et partenaires de l’événement et ne pas consommer ou acheter leurs produits : McDonalds, Coca-Cola, Budweiser, Adidas, Hyundai, KIA, Qatar Airways, VISA, Crypto.com, BYJU&apos;S, Wanda Group, Hisense, VIVO, Mengniu.
                            </li>
                            <li>
                                Signer des pétitions, comme <a href="https://www.amnesty.fr/petitions/coupe-du-monde-qatar-2022-fff?utm_medium=boycottqatar2022.fr">celle d’Amnesty International</a> et celle de <a href="https://www.change.org/p/m-le-pr%C3%A9sident-ne-participez-pas-%C3%A0-la-coupe-du-monde-au-qatar">Raphaël Glucksmann</a>
                            </li>
                            <li>
                    ...
                    <div className="further-action">
                        ...
                        <p>
                            ...
                            tartiflette, montre au monde que la vie continue aussi sans la Coupe du monde avec le hashtag <strong>#HappyBoycott</strong> !
                        </p>
                    </div>
                </div>
